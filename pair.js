    ...
    const {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let md = "humba~" + string_session;
                        let code = await sock.sendMessage(sock.user.id, { text: md });
                        let desc = `*Hey there, bleurainz-XD User!* 👋🏻

Thanks for using *bleurainz-XD* — your session has been successfully created!
...
externalAdReply: {
title: "bleurainz-xᴅ",
thumbnailUrl: "https://files.catbox.moe/9b9kao.jpg",
